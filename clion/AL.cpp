...
LISTE remplir_liste_reference(LISTE liste_reference)
{
    ...
    liste_reference=remplir_liste_fonction(liste_reference,fonction_sqrt,FONCTION,VAL_NEG);
...
{
    printf("rentrer ici la fonction souhaitee, entre parentheses\n");
...
{
    if((saisie_fonction[*compteur_saisie]>='a')&&(saisie_fonction[*compteur_saisie]<='z'))
    {
